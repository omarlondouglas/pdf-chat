...
const GlowEffects = memo(function GlowEffects({
  ...
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-white/15 to-white/10 backdrop-blur-2xl rounded-3xl"></div>
      ...
      <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-30 transition-opacity duration-300 overflow-hidden blur-sm">
        <div
          className="absolute inset-0 bg-gradient-to-r from-transparent via-purple-400/10 to-transparent transform -translate-x-full group-hover:translate-x-full"
          style={{
      ...
      <div
        className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-25 bg-gradient-to-r from-transparent via-white/5 to-transparent animate-pulse blur-sm"
        style={{
          transitionProperty: "opacity",
          transitionDuration: `${animationDuration}ms`,
        }}
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="h-8 w-8 flex items-center justify-center rounded-full transition-all ml-1 mr-1"
        style={{
          color: textColor,
          backgroundColor: `${textColor}1A`,
        }}
...
export default function ChatGPTInput({
  ...
  const baseWidthClass = hasModeSelected ? "w-96" : "w-72";
  const focusWidthClass = shouldExpandOnFocus ? "focus-within:w-[40rem]" : "";

  return (
    <ChatInputContext.Provider value={contextValue}>
      <form
        onSubmit={handleSubmit}
        className={`mx-auto min-h-12 ${baseWidthClass} ease-out ${focusWidthClass} translate-y-0 opacity-100`}
        style={{
      ...
      >
        <div
          ...
          onClick={handleClick}
          className="relative flex flex-col w-full min-h-full backdrop-blur-xl shadow-lg rounded-3xl p-2 overflow-visible group"
          style={{
